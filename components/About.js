   ...
   <>
    <div className={styles.container}>
      ...
      <div className={!mobile?styles.abouttext:styles.abouttextmobile} style={{marginBottom:'2vh',width:mobile?'100%':'70%'}}>
        ...
        <br/><br/>As a <span className={styles.altcol}>Student</span>  he is currently pursuing a <span style={{fontStyle:'italic',fontWeight:100}}>Bachelor of Engineering </span> in Computer Science. Previously, he held a position as an <span style={{fontStyle:'italic',fontWeight:100}}>SDE Intern </span>at <a href="https://mystry.io/" target="_blank" className={styles.altcol}>Mystry Inc</a> where he worked with cool people trying to disrupt the sneaker-tech market.<br/><br/>  As a<span className={styles.altcol}> Developer </span> he has developed a passion for building <span style={{fontStyle:'italic',fontWeight:100}}>Innovative Web Applications</span>. His domains of interest are Software Development, Microservices, DevOps, Blockchain, FinTech and Business.
        <br /><br />
        As an <span className={styles.altcol}>Entrepreneur</span>, he is currently building a <span style={{fontStyle:'italic',fontWeight:100}}>SaaS</span> product together with some interesting people. More on that soon!<br/><br/>
